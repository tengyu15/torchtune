...
def llama3_2_vision_90b(
    ...
    Returns:
        DeepFusionModel: Instantiation of the Llama 3.2 Vision 90B model
    """
    encoder = llama3_2_vision_encoder(
        patch_size=14,
        num_heads=16,
...
qlora_llama3_2_vision_90b = partial(lora_llama3_2_vision_90b, quantize_base=True)

qlora_llama3_2_vision_90b.__doc__ = """
Builder for creating a Llama3.2 vision 90B model with QLoRA enabled. Base model weights in linear layers
that LoRA is applied to are quantized per the QLoRA paper: https://arxiv.org/abs/2305.14314.
Please see `lora_llama3_2_vision_90b` for full API arguments.
"""
